...
$script = "dotnet"
$scriptArguments = "$PSScriptRoot\ps_modules\cosmostools\CosmosDB.DeleteCollection.dll -DatabaseName $databaseName -CollectionName $collectionName -EndPointUrl $endPointUrl -AuthorizationKey $authorizationKey -Y"
